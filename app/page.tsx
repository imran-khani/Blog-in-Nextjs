      ...
      >
        <MotionDiv className="lg:flex-grow md:w-1/2 py-12  md:pr-16 flex flex-col md:items-start  mb-16 md:mb-0  ">
          ...
          <p className="mb-8 leading-relaxed dark:text-white ">
            Hey there! Im Imran Khan, a frontend developer specializing in React
            and Next.js. For two years, Ive been weaving creativity into code to
            build captivating digital experiences. Join me on this journey as we
            shape the future of the web, pixel by pixel.
          </p>
